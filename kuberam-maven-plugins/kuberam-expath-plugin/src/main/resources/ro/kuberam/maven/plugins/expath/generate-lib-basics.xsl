...
<xsl:stylesheet
    ...
    <xsl:param name="libDirPath" required="yes" as="xs:string"/>
    <xsl:param name="javaPackageName" required="yes" as="xs:string"/>
	<xsl:param name="libVersion" required="yes" as="xs:string"/>
	<!-- xsl:param name="libUrl" / -->
	<!-- xsl:param name="libArtifactId" / -->
	<xsl:param name="libName" required="yes" as="xs:string"/>
